...
public class DyeMixer extends javax.swing.JFrame {
    ...
    static class Light implements Sortable, HasNumber {
        ...
        void normalizeWhite() {
            ...
            if (xyz[0] > 0) xscale = 0.9505 / xyz[0];
            else xscale = 1.0;
            if (xyz[1] > 0) yscale = 1.0000 / xyz[1];
            else yscale = 1.0;
            if (xyz[2] > 0) zscale = 1.0890 / xyz[2];
            else zscale = 1.0;
        }
    ...
    public void init() {
        ...
        // | 2panel4 |
        // +---------+
        Panel ui_2panel1 = new Panel();
        ui_panel2.add(ui_2panel1);
        Panel ui_2panel2 = new Panel();
        ui_panel2.add(ui_2panel2);
        Panel ui_2panel3 = new Panel();
        ui_panel2.add(ui_2panel3);
        Panel ui_2panel4 = new Panel();
        ui_panel2.add(ui_2panel4);
        ...
        //             |                                            |
        //             +--------------------------------------------+
        Panel ui_21panel1 = new Panel();
        ui_2panel1.add(ui_21panel1);
        Panel ui_21panel2 = new Panel();
        ui_2panel1.add(ui_21panel2);
        ...
        Panel ui_22panel1 = new Panel();
        ui_2panel2.add(ui_22panel1);
        Panel ui_22panel2 = new Panel();
        ui_2panel2.add(ui_22panel2);
        ...
        Panel ui_23panel2 = new Panel();
        ui_2panel3.add(ui_23panel2);
        Panel ui_23panel1 = new Panel();
        ui_2panel3.add(ui_23panel1);
        Panel ui_23panel3 = new Panel();
        ui_2panel3.add(ui_23panel3);
        Panel ui_23panel4 = new Panel();
        ui_2panel3.add(ui_23panel4);
        Panel ui_23panel5 = new Panel();
        ui_2panel3.add(ui_23panel5);
        ...
        Panel ui_24panel1 = new Panel();
        ui_2panel4.add(ui_24panel1);
        ...
        Panel ui_211panel1 = new Panel();
        ui_21panel1.add(ui_211panel1);
        Panel ui_221panel1 = new Panel();
        ui_22panel1.add(ui_221panel1);
